...
dfus <- read.csv(file.path(datafolder,"merged_us_coha.csv"))
...
write.csv(granger_results_chi, file = file.path(grangerfolder, "diff_granger_results_chi_24Oct.csv"), row.names = FALSE)
write.csv(model_results, file = file.path(arimafolder, "arima_model_results_chi_24Oct.csv"), row.names = FALSE)
write.csv(model_GDP_results, file = file.path(arimafolder, "arima_model_GDP_results_chi_24Oct.csv"), row.names = FALSE)
# Save the model results
stargazer(model_list_chi, summary = FALSE, type = "text", column.labels = model_names_chi, star.cutoffs = c(0.05, 0.01, 0.001),title = "ARIMA Results for China", out = file.path(arimafolder, "arima_model_Culturalz_chi_24Oct.txt"))
stargazer(model_list_GDP_chi, summary = FALSE, type = "text", column.labels = model_GDP_names_chi, star.cutoffs = c(0.05, 0.01, 0.001),title = "ARIMA Results (including GDP) for China", out = file.path(arimafolder, "arima_model_GDPz_Culturalz_chi_24Oct.txt"))
...
# Save the model results
write.csv(granger_results_us, file = file.path(grangerfolder, "diff_granger_results_us_coha.csv"), row.names = FALSE)
write.csv(model_results, file = file.path(arimafolder, "arima_model_results_us_coha.csv"), row.names = FALSE)
write.csv(model_GDP_results, file = file.path(arimafolder, "arima_model_GDP_results_us_coha.csv"), row.names = FALSE)
stargazer(model_list_us, summary = FALSE, ci = TRUE,type = "text", column.labels = model_names_us, star.cutoffs = c(0.05, 0.01, 0.001), title = "ARIMA Results for US", out = file.path(arimafolder, "arima_model_Culturalz_us_coha.txt"))
stargazer(model_list_GDP_us, summary = FALSE, type = "text", column.labels = model_GDP_names_us, star.cutoffs = c(0.05, 0.01, 0.001), title = "ARIMA Results (including GDP) for US", out = file.path(arimafolder, "arima_model_GDPz_Culturalz_us_coha.txt"))
...
stargazer(model_list_GDP,summary = FALSE,type = "text",column.labels = model_GDP_names,star.cutoffs = c(0.05,0.01,0.001), title = "ARIMA Results (only GDP) for US",out = file.path(arimafolder,"arima_model_onlyGDP_us_coha.txt"))
model_list_GDP <- list()
model_GDP_names <- c()
for (j in 1:length(dvs)){
  y_ts <- ts(dfchi[,dvs[j]])
