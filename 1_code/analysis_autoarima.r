...
if (!dir.exists(arimafolder)) {
  dir.create(arimafolder, recursive = TRUE)
}
if (!dir.exists(grangerfolder)) {
  dir.create(grangerfolder, recursive = TRUE)
}
# auto.arima
...
write.csv(granger_results_chi, file = file.path(grangerfolder, "diff_granger_results_chi.csv"), row.names = FALSE)
write.csv(model_results, file = file.path(arimafolder, "arima_model_results_chi.csv"), row.names = FALSE)
write.csv(model_GDP_results, file = file.path(arimafolder, "arima_model_GDP_results_chi.csv"), row.names = FALSE)
...
write.csv(granger_results_us, file = file.path(grangerfolder, "diff_granger_results_us.csv"), row.names = FALSE)
write.csv(model_results, file = file.path(arimafolder, "arima_model_results_us.csv"), row.names = FALSE)
write.csv(model_GDP_results, file = file.path(arimafolder, "arima_model_GDP_results_us.csv"), row.names = FALSE)
